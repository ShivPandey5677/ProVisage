...
<html lang="en">
  ...
  //     $sql = "Insert into User(name,email,password) values('$_POST[username]','$_POST[email]','$_POST[pass2]');";
  //     $login = 1;
  ...
  ?> -->
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">ProVisage</a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" aria-disabled="false" href="./login.html">Log In</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" aria-disabled="false" href="./signup.html">Sign Up</a>
                    </li>
                  </ul>
              </div>
              </div>
