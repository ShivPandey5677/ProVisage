...
?>
    ...
    <div>
        <div id="p">
            <img src="ii.jpg" class="center">
            <div id="k">
        <form>
            <h1><B>Hello<br>It's</B></h1>
            <h1><?php echo $name; ?></h1><br> </div>

        </form>

        <div id="u"><h1><i>I am a Writer
            <h2>Welcome To My Portfolio..</h2>
    <h4>I am a dedicated and creative web developer passionate about crafting engaging and responsive web experiences.</i> </h4> 
         </h1><br></div>
...
<div class="container">
  <footer class="py-3 my-4">
    CONNECT TO ME ON:<br><br>
    <ul class="nav justify-content-center border-bottom pb-3 mb-3">
      <li class="nav-item"><a href="#p" class="nav-link px-2 text-body-secondary">Home</a></li>
      <br><br>
      <li class="nav-item"><a href="<?php echo $linkedin; ?>" class="nav-link px-2 text-body-secondary">BlogPage</a></li>
      <br><br>
