...
<body>
    <div class="container">
        <div class="login">
            <form action="./back/ph.php" method="POST" enctype="multipart/form-data">
               ...
               <label for="Link" class="labeling">Pintrest</label><br><input type="text" name="linkedIn" class="data"><br><br>  
